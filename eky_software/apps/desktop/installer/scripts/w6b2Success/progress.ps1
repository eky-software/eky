...
$script:W6b2SuccessSafeErrorCodes = @(
  ...
  'W6B2_SUCCESS_OWNED_GPU_REMAINS',
  ...
  'W6B2_SUCCESS_SOURCE_INSTALL_CLEANUP_FAILED',
  'W6B2_SUCCESS_SOURCE_INSTALL_REBOOT_REQUIRED',
  'W6B2_SUCCESS_SOURCE_INSTALL_RELATED_PRODUCT_PRESENT',
  'W6B2_SUCCESS_SOURCE_INSTALL_START_FAILED',
  'W6B2_SUCCESS_SOURCE_INSTALL_TIMEOUT',
  'W6B2_SUCCESS_SOURCE_INSTALL_WAIT_FAILED',
  ...
  'W6B2_SUCCESS_UNINSTALL_CLEANUP_FAILED',
  'W6B2_SUCCESS_UNINSTALL_FAILED',
  'W6B2_SUCCESS_UNINSTALL_START_FAILED',
  'W6B2_SUCCESS_UNINSTALL_TIMEOUT',
  'W6B2_SUCCESS_UNINSTALL_WAIT_FAILED',
...
function Resolve-W6b2SuccessSafeErrorCode {
  ...
  if ($null -ne $ErrorRecord) {
    ...
    if ($candidate -cmatch '^W6B2_SUCCESS_UNINSTALL_FAILED:[0-9]+$') {
      return 'W6B2_SUCCESS_UNINSTALL_FAILED'
    }
