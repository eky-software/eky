...
import {
  WORKSPACE_SUCCESS_PROFILE_ERRORS, WORKSPACE_INSTALLATION_INSPECTION_ERRORS, WORKSPACE_PROOF_REJECTION_ERRORS,
...
export const WORKSPACE_FAULT_ERRORS = Object.freeze([
  ...
  ...WORKSPACE_PROOF_REJECTION_ERRORS,
  ...
  'W6B2_FAULT_PROOF_CURRENT_SOURCE_VALIDATION_FAILED',
  'W6B2_FAULT_PROOF_CURRENT_CACHE_PREPARATION_FAILED',
  'W6B2_FAULT_PROOF_CURRENT_PACKAGE_COPY_FAILED',
  'W6B2_FAULT_PROOF_CURRENT_STAGED_VALIDATION_FAILED',
  'W6B2_FAULT_PROOF_CURRENT_SLOT_PUBLICATION_FAILED',
  'W6B2_FAULT_PROOF_CURRENT_SLOT_VALIDATION_FAILED',
  'W6B2_FAULT_PROOF_CANDIDATE_SOURCE_VALIDATION_FAILED',
  'W6B2_FAULT_PROOF_CANDIDATE_CACHE_PREPARATION_FAILED',
  'W6B2_FAULT_PROOF_CANDIDATE_PACKAGE_COPY_FAILED',
  'W6B2_FAULT_PROOF_CANDIDATE_STAGED_VALIDATION_FAILED',
  'W6B2_FAULT_PROOF_CANDIDATE_SLOT_PUBLICATION_FAILED',
  'W6B2_FAULT_PROOF_CANDIDATE_SLOT_VALIDATION_FAILED',
