...
// Reserve SQLite journal suffix space as well as the snapshot database path.
export const WORKSPACE_SUCCESS_RUN_ROOT_PREFIX = 'v26-';
...
export function workspaceSuccessRunContext(requestPath, request, artifact) {
  ...
  const temporaryRoot = resolve(scenarioRoot, 'p');
