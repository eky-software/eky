...
export const uiText = {
  ...
  workspaces: {
    active: 'Aktiivinen yritys',
    addWorkspace: 'Lisää yritys Ekyyn',
    back: 'Takaisin',
    browserSubtitle: 'Paikallinen',
    busySubtitle: 'Toiminto käynnissä…',
    ...
    fallbackName: 'Eky',
    heading: 'Yritykset',
    importBackup: 'Tuo yritys varmuuskopiosta',
    importHelp:
      'Valitse seuraavaksi .ekybackup-tiedosto. Varmuuskopio tuodaan uutena yrityksenä.',
    kicker: 'Paikalliset yritykset',
    loading: 'Ladataan yrityksiä...',
    loadingWorkspace: 'Ladataan yritystä…',
    localSubtitle: 'Eky · Paikallinen',
    noWorkspaces: 'Ekyssä ei ole vielä paikallisia yrityksiä.',
    openWorkspace: 'Avaa yritys',
    processing: 'Toimintoa valmistellaan turvallisesti...',
    ready: 'Valmis avattavaksi',
    recoveryRequired:
      'Yritysten hallinta odottaa palautuksen tarkistusta. Viimeistele palautus ennen muutoksia.',
    ...
    selectorLabel: (workspaceLabel: string) =>
      `Vaihda yritystä. Aktiivinen yritys: ${workspaceLabel}`,
    switchConfirmation: 'Eky vaihtaa yrityksen ja käynnistyy uudelleen.',
    unavailableSubtitle: 'Yritystiedot eivät ole käytettävissä',
    workspaceName: 'Yrityksen nimi',
    workspaceNameRequired: 'Anna yritykselle nimi.',
  },
  activity: {
    changeCategories: {
  ...
  companySettings: {
    ...
    localUpdateTitle: 'Sovellus ja päivitykset',
    localUpdateDescription:
      'Tarkista paikallisen työpöytäsovelluksen versio ja valitse hallitulla medialla saatu Eky-päivityspaketti.',
    localUpdateUnavailable:
      'Paikallinen päivitystoiminto on käytettävissä vain Eky-työpöytäsovelluksessa.',
    localUpdateLoading: 'Tarkistetaan päivityksen tilaa...',
    localUpdateError:
      'Päivityksen tilaa tai pakettia ei voitu käsitellä turvallisesti.',
    localUpdateCurrentVersion: 'Nykyinen versio',
    localUpdateBuild: 'Koontitunniste',
    localUpdateChannel: 'Julkaisukanava',
    localUpdateRollbackPackage: 'Palautuspaketti',
    localUpdateReady: 'Valmis',
    localUpdateMissing: 'Puuttuu',
    localUpdateCandidate: 'Valittu päivitys',
    localUpdateNoCandidate: 'Ei valittua päivitystä',
    localUpdatePhase: 'Päivityksen tila',
    localUpdateRecoveryPoint: 'Palautuspiste',
    localUpdateUnsignedWarning:
      'Pilot-päivitystä ei ole allekirjoitettu digitaalisesti. Käytä vain suoraan Eky-kehittäjältä hallitulla medialla saatua pakettia.',
    localUpdateSelectCurrent: 'Valitse nykyinen palautuspaketti',
    localUpdateSelectCandidate: 'Valitse päivityspaketti',
    localUpdateSelecting: 'Tarkistetaan pakettia...',
    localUpdateDiscard: 'Hylkää valittu päivitys',
    localUpdateStart: 'Aloita päivitys',
    localUpdateStarting: 'Valmistellaan päivitystä...',
    localUpdatePhaseIdle: 'Ei käynnissä olevaa päivitystä',
    localUpdatePhasePreparing: 'Valmistellaan',
    localUpdatePhaseApplying: 'Asennus käynnistyy',
    localUpdatePhaseValidating: 'Tarkistetaan asennusta',
    localUpdatePhaseAccepted: 'Hyväksytty',
    localUpdatePhaseNotApplied: 'Asenninta ei suoritettu',
    localUpdatePhaseRollingBack: 'Palautetaan aiempaa versiota',
    localUpdatePhaseRolledBack: 'Palautettu aiempaan versioon',
    localUpdatePhaseFailed: 'Päivitys epäonnistui',
    localUpdatePhaseRecoveryRequired: 'Manuaalinen palautus vaaditaan',
    localUpdateRecoveryNotStarted: 'Ei luotu',
    localUpdateRecoveryPending: 'Odottaa luontia',
    localUpdateRecoveryReady: 'Valmis',
    localUpdateRecoveryRequired: 'Palautustoimi vaaditaan',
    save: 'Tallenna',
