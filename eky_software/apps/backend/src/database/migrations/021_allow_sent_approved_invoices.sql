ALTER TABLE invoice_documents RENAME TO invoice_documents_old;
...
CREATE TABLE invoices (
  ...
  status TEXT NOT NULL CHECK (status IN ('approved', 'reopened_for_edit', 'sent')),
...
SELECT * FROM invoice_documents_old;

DROP TABLE invoice_documents_old;
