...
| RESTORE-ROLLBACK-001 | P0; integration, fault, recovery | Virhe jokaisen aktivointijournalin vaiheen jälkeen | Vanha profiili palautuu terveeksi | Journal on idempotentti; osittaista profiilia ei hyväksytä | Profiilipolku tai raw failure | covered-existing |
