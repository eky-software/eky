...
| UPDATE-PACKAGE-001 | P0; unit, integration, electron-e2e, security | Sama versio, downgrade, väärä app identity, väärä arkkitehtuuri tai hash mismatch | Paketti torjutaan ennen recovery pointia, maintenancea ja prosessin käynnistystä | Ei journalia tai sivuvaikutusta | Manifesti, raakaversioinput, polku tai executable | planned-r0 |
